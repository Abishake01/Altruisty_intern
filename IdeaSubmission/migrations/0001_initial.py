# Generated by Django 5.1.2 on 2024-12-23 06:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statementcategory', models.CharField(max_length=250)),
                ('at1', models.CharField(blank=True, max_length=250, null=True)),
                ('at2', models.CharField(blank=True, max_length=250, null=True)),
                ('at3', models.CharField(blank=True, max_length=250, null=True)),
                ('at4', models.CharField(blank=True, max_length=250, null=True)),
                ('at5', models.CharField(blank=True, max_length=250, null=True)),
            ],
            options={
