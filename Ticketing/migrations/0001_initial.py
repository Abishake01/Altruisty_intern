    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_type', models.CharField(choices=[('Technical', 'Technical'), ('Payment', 'Payment'), ('Others', 'Others')], max_length=20)),
                ...
                ('levels', models.IntegerField(blank=True, choices=[(1, 'Level 1'), (2, 'Level 2'), (3, 'Level 3')], null=True)),
